...
import 'package:ebookapp/screens/details_screen.dart';
import 'package:ebookapp/widgets/book_rating.dart';
import 'package:ebookapp/widgets/reading_card_list.dart';
                    ...
                    child: Row(
                      children: <Widget>[
                        ReadingListCard(
                          ...
                          pressRead: () {
                            // Add the logic for the pressRead action
                          },
                        ),
                        ReadingListCard(
                          ...
                          rating: 4.8,
                          pressDetails: () {
                            // Add the logic for the pressDetails action
                          },
                          pressRead: () {
                            // Add the logic for the pressRead action
                          },
